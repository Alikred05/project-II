    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:placeholder-teal-300 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-3xl text-course-details-heading-small font-semibold text-gray-800">
        ...
        {/* right column */}
        <div className="max-w-full md:max-w-xl shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-2xl overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] z-10">
          ...
          <div className="p-5 space-y-4">
            ...
            {/* Course meta info */}
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-gray-600 border-t pt-4">
              ...
              <div className="flex items-center gap-1">
                <img src={assets.lesson_icon} alt="lesson count" className="w-4 h-4" />
                <p>{calculateNoOfLecture(courseData)} lessons</p>
              </div>
            </div>
            <button className="md:mt-6 mt-4 w-full py-3 rounded text-center  bg-blue-600 text-white font-medium"> {isAlreadyEnrolled ? "Enrolled" : "Enroll Now"} </button>
            <div className="pt-6">
